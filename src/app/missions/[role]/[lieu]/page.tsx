...
export default function MissionsPage({
  ...
  // Fallback: si pas de missions pour ce rôle, propose les autres disponibles
  const availableRoles = missionsData[lieu] ? Object.keys(missionsData[lieu]) : [];
  const hasNoMissions = missions.length === 0;
